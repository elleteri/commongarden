...
# Read raw data in, DONT RUN if done already#### 
##METADATA READ IN
...
### Remove duplicates
rows_to_remove <- c('CAT.2.9_2012v1', 'CAV.2.7_2012v2','NVT.2.9_2012v2','ORT.2.10_2012v1','WAT.1.4_2012v2','WAT.1.9_2012v2','WAT.2.8_2012v1', 'ORT.1.5_2012', 'MTW.3.7.R_2012')
