...
asvITS.OCG <- read.csv("data_csv/asvITS.OCG.csv",head=T, row.names = 1, check.names = F,stringsAsFactors = T)
head(asvITS.OCG)
summary(rowSums(asvITS.OCG)) #1021
summary(colSums(asvITS.OCG)) #2

tax.ITS <- read.csv("~/Documents/Orchard_Common _Garden/Shared_OCG_Code/data_csv/taxonomy.csv", head=T, row.names = 1, check.names = F)
```
