...
asvITS<- asvITS[,order(colnames(asvITS))] # alphabetically
...
colnames(asvITS) == row.names(mdITS) 

# Replace "2020" with "2021" at the end of the strings for plant description ID
...
row.names(asvITS.OCG) == row.names(mdITS.OCG) # TRUE
